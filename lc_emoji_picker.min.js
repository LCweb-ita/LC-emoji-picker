...
n=null,!1;this.reset_picker();n=b;b=a.offsetWidth;var c=n.getBoundingClientRect(),d=parseInt(n.clientHeight,10);d=parseInt(c.y,10)+parseInt(window.pageYOffset,10)+d+5;b=parseInt(c.right,10)-b;0>b&&(b=0);a.setAttribute("style","top: "+d+"px; left: "+b+"px;");a.classList.add("lcep-shown")};this.emoji_select=function(b){var a=n.parentNode.querySelector("input, textarea");a.value+=b.innerText;"function"==typeof f.selection_callback&&f.selection_callback.call(this,b,a)};this.wrap_element=function(b){var a=
this,c=Math.random().toString(36).substr(2,9),d="";Object.keys(f.trigger_position).some(function(m){d+=m+":"+f.trigger_position[m]+";"});var g=document.createElement("div");g.innerHTML='<span id="'+c+'" class="lcep-trigger" style="'+d+'" title="insert emoji">'+f.picker_trigger+"</span>"+b.outerHTML;g.getElementsByTagName(b.tagName)[0].value=b.value;g.classList.add("lcep-el-wrap");b.parentNode.insertBefore(g,b);b.remove();var p=document.getElementById(c);p.addEventListener("click",function(m){a.show_picker(p)})};
this.fetch_emoji_data=function(){var b=this;fetch(f.emoji_json_url).then(function(a){return a.json()}).then(function(a){e=a;b.init()})};this.append_emoji_picker=function(){var b=this;if(document.getElementById("lc-emoji-picker"))return!0;var a='\n            <div id="lc-emoji-picker">\n                <div class="lcep-categories">%categories%\n                    <div class="lcep-search">\n                        <input placeholder="Search emoji" />\n                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.005 512.005" xml:space="preserve"><g><g><path d="M505.749,475.587l-145.6-145.6c28.203-34.837,45.184-79.104,45.184-127.317c0-111.744-90.923-202.667-202.667-202.667S0,90.925,0,202.669s90.923,202.667,202.667,202.667c48.213,0,92.48-16.981,127.317-45.184l145.6,145.6c4.16,4.16,9.621,6.251,15.083,6.251s10.923-2.091,15.083-6.251C514.091,497.411,514.091,483.928,505.749,475.587z M202.667,362.669c-88.235,0-160-71.765-160-160s71.765-160,160-160s160,71.765,160,160S290.901,362.669,202.667,362.669z"/></g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>\n                        <i>\u00d7</i>\n                    </div>\n                </div>\n                <div>%pickerContainer%</div>\n            </div>',
c="",d="",g=0,p=e,m;for(m in p)if(p.hasOwnProperty(m)){g++;var r=m.split(" ").join("-").split("&").join("").toLowerCase(),v=p[m];c+='\n                    <li class="'+(1===g?"lcep-active":"")+'" data-index="'+r+'" title="'+m+'">\n                        <a href="javascript:void(0)">'+t[r]+"</a>\n                    </li>";d+='\n                    <ul class="lcep-category" category-name="'+r+'">\n                        <div class="lcep-container-title">'+m+'</div>\n                        <div class="lcep-grid">';
v.forEach(function(k){d+='\n                                <li data-name="'+k.description.toLowerCase()+'">\n                                    <a class="lcep-item" title="'+k.description+'" data-name="'+k.description.toLowerCase()+'" data-code="'+k.code+'" href="javascript:void(0)">'+k.emoji+"</a>\n                                </li>"});d+="\n                        </div>\n                    </ul>"}g='<div class="lcep-all-categories">%outerUL%</div>'.replace("%outerUL%",d);c="<ul>%categories%</ul>".replace("%categories%",
c);a=a.replace("%pickerContainer%",g).replace("%categories%",c);document.body.insertAdjacentHTML("beforeend",a);a={};c=$jscomp.makeIterator(document.querySelectorAll(".lcep-categories li"));for(g=c.next();!g.done;a={$jscomp$loop$prop$cat$10:a.$jscomp$loop$prop$cat$10},g=c.next())a.$jscomp$loop$prop$cat$10=g.value,a.$jscomp$loop$prop$cat$10.addEventListener("click",function(k){return function(w){b.go_to_emoji_cat(k.$jscomp$loop$prop$cat$10,k.$jscomp$loop$prop$cat$10.getAttribute("data-index"))}}(a));
a=$jscomp.makeIterator(document.querySelectorAll(".lcep-container-title"));for(c=a.next();!c.done;c=a.next())c=c.value,q[c.offsetTop-101]=c.parentNode.getAttribute("category-name");document.querySelector(".lcep-all-categories").addEventListener("scroll",function(){b.cat_waypoints_check()});document.querySelector(".lcep-search i").addEventListener("click",function(k){b.clear_search()});a={};c=$jscomp.makeIterator(document.querySelectorAll(".lcep-all-categories li"));for(g=c.next();!g.done;a={$jscomp$loop$prop$emoji$12:a.$jscomp$loop$prop$emoji$12},
g=c.next())a.$jscomp$loop$prop$emoji$12=g.value,a.$jscomp$loop$prop$emoji$12.addEventListener("click",function(k){return function(w){b.emoji_select(k.$jscomp$loop$prop$emoji$12)}}(a))};this.generate_style=function(){document.head.insertAdjacentHTML("beforeend","\n                <style>\n                .lcep-el-wrap {\n                    position: relative;\n                }\n                .lcep-el-wrap > textarea,\n                .lcep-el-wrap > input {\n                    padding-right: "+
f.target_r_padding+'px;\n                }\n                .lcep-trigger {\n                    display: inline-block;\n                    position: absolute;\n                    width: 22px;\n                    height: 22px;\n                    cursor: pointer;\n                }\n                .lcep-trigger svg {\n                    width: 100%;\n                    height: 100%;\n                    border-radius: 50%;\n                    border: 2px solid transparent;\n                    opacity: 0.8;\n                    fill: #282828;\n                    transition: all .15s ease;\n                }\n                .lcep-trigger svg:hover {\n                    fill: #202020;\n                }\n                #lc-emoji-picker,\n                #lc-emoji-picker * {\n                    box-sizing: border-box;\n                }\n                #lc-emoji-picker {\n                    visibility: hidden;\n                    z-index: -100;\n                    opacity: 0;\n                    position: absolute;\n                    top: -9999px;\n                    z-index: 999;\n                    width: 280px;\n                    min-height: 320px;\n                    background: #fff;\n                    box-shadow: 0px 2px 13px -2px rgba(0, 0, 0, 0.18);\n                    border-radius: 6px;\n                    overflow: hidden;\n                    border: 1px solid #ccc;\n                    transform: scale(0.85);\n                    transition: opacity .2s ease, transform .2s ease;\n                }\n                #lc-emoji-picker.lcep-shown {\n                    visibility: visible;\n                    z-index: 999;\n                    transform: none;\n                    opacity: 1;\n\n                }\n                #lc-emoji-picker .lcep-all-categories {\n                    height: 260px;\n                    overflow-y: auto;\n                    padding: 0 5px 20px 10px;\n                }\n                #lc-emoji-picker .lcep-category:not(:first-child) {\n                    margin-top: 22px;\n                }\n                #lc-emoji-picker .lcep-container-title {\n                    color: black;\n                    margin: 10px 0;\n                    text-indent: 10px;\n                    font-size: 13px;\n                    font-weight: bold;\n                }\n                #lc-emoji-picker * {\n                    margin: 0;\n                    padding: 0;\n                    text-decoration: none;\n                    color: #666;\n                    font-family: sans-serif;\n                    user-select: none;\n                    -webkit-tap-highlight-color:  rgba(255, 255, 255, 0);\n                }\n                .lcep ul {\n                    list-style: none;\n                    margin: 0;\n                    padding: 0;\n                }\n                .lcep-grid {\n                    display: flex;\n                    flex-wrap: wrap;\n                }\n                .lcep-grid > li {\n                    cursor: pointer;\n                    flex: 0 0 calc(100% / 6);\n                    max-width: calc(100% / 6);\n                    height: 41px;\n                    min-width: 0;\n                    display: flex;\n                    justify-content: center;\n                    align-items: center;\n                    background: #fff;\n                    border-radius: 2px;\n                    transition: all .2s ease;\n                }\n                .lcep-grid > li:hover {\n                    background: #99c9ef;\n                }\n                .lcep-grid > li > a {\n                    display: block;\n                    font-size: 21px;\n                    margin: 0;\n                    padding: 22px 0px;\n                    line-height: 0;\n                }\n                .lcep-categories ul {\n                    display: flex;\n                    flex-wrap: wrap;\n                    list-style: none;\n                }\n                .lcep-categories li {\n                    transition: all .3s ease;\n                    flex: 0 0 calc(100% / 7);\n                    display: flex;\n                    max-width: calc(100% / 7);\n                }\n                .lcep-categories li.lcep-active {\n                    box-shadow: 0 -3px 0 #48a6f0 inset;\n                }\n                .lcep-categories a {\n                    padding: 7px !important;\n                    font-size: 19px;\n                    height: 42px;\n                    display: flex;\n                    text-align: center;\n                    justify-content: center;\n                    align-items: center;\n                    position: relative;\n                    filter: grayscale(100%) contrast(150%);\n                }\n                .lcep-categories a:before {\n                    content: "";\n                    position: absolute;\n                    top: 0;\n                    left: 0;\n                    right: 0;\n                    bottom: 0;\n                    background: rgba(255, 255, 255, .2);\n                    cursor: pointer;\n                    transition: background .25s ease;\n                }\n                .lcep-categories li:not(.lcep-active):hover a:before {\n                    background: rgba(255, 255, 255, .4);\n                }\n                .lcep-search {\n                    position: relative;\n                    border-top: 1px solid #ddd;\n                    padding: 10px 6px !important;\n                }\n                .lcep-search input {\n                    width: 100%;\n                    border: none;\n                    padding: 8px 30px 8px 10px !important;\n                    outline: none;\n                    background: #fff;\n                    font-size: 13px;\n                    color: #616161;\n                    border: 2px solid #ddd;\n                    height: 30px;\n                    border-radius: 25px;\n                    user-select: auto !important;\n                }\n                .lcep-search svg,\n                .lcep-search i {\n                    width: 14px;\n                    height: 14px;\n                    position: absolute;\n                    right: 16px;\n                    top: 18px;\n                    fill: #444;\n                    cursor: pointer;\n                }\n                .lcep-search i {\n                    color: #444;\n                    font-size: 22px;\n                    font-family: arial;\n                    line-height: 14px;\n                    transition: opacity .15s ease;\n                }\n                .lcep-search i:hover {\n                    opacity: .8;\n                }\n                .lcep-searching svg,\n                .lcep-search:not(.lcep-searching) i {\n                    display: none;\n                }\n                .lcep-footer {\n                    display: flex;\n                    flex-wrap: wrap;\n                    align-items: center;\n                    height: 50px;\n                    padding: 0 15px 15px 15px;\n                }\n                .lcep-footer-icon {\n                    font-size: 30px;\n                    margin-right: 8px;\n                }\n            </style>')};
this.init()}})();